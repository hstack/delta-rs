...
use crate::delta_datafusion::relax_schema_nested_nullability;
...
pub fn build_expr_adapter_factory() -> Option<Arc<dyn PhysicalExprAdapterFactory>> {
    ...
    match flag {
        ...
        _ => Some(Arc::new(DeltaDeepPhysicalExprAdapterFactory) as Arc<dyn PhysicalExprAdapterFactory>),
    }
}

#[derive(Debug, Clone)]
pub struct DeltaDeepPhysicalExprAdapterFactory;

impl PhysicalExprAdapterFactory for DeltaDeepPhysicalExprAdapterFactory {
    fn create(
        &self,
        logical_file_schema: SchemaRef,
        physical_file_schema: SchemaRef,
    ) -> Result<Arc<dyn PhysicalExprAdapter>> {
        let adapter = DeltaDeepPhysicalExprAdapter::new(
...
#[derive(Debug, Clone)]
pub struct DeltaDeepPhysicalExprAdapter {
    logical_file_schema: SchemaRef,
    physical_file_schema: SchemaRef,
}

impl DeltaDeepPhysicalExprAdapter {
...
impl PhysicalExprAdapter for DeltaDeepPhysicalExprAdapter {
    fn rewrite(&self, expr: Arc<dyn PhysicalExpr>) -> Result<Arc<dyn PhysicalExpr>> {
        let rewriter = DefaultDeepPhysicalExprAdapterRewriter {
...
struct DefaultDeepPhysicalExprAdapterRewriter<'a> {
    logical_file_schema: &'a Schema,
    physical_file_schema: &'a Schema,
}

impl<'a> DefaultDeepPhysicalExprAdapterRewriter<'a> {
    fn rewrite_expr(
        &self,
    ...
    fn evaluate(&self, batch: &RecordBatch) -> Result<ColumnarValue> {
        ...
        match value {
            ColumnarValue::Array(array) => {
                ...
                let casted =
                    cast_column(&array, self.target_field.data_type(), &self.cast_options)?;
